          ...
          <div>
            ...
            <ul className="mt-3">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <i className={`bx bxs-dashboard text-2xl fill-current ${pathname.includes('tasks') ? 'text-indigo-500' : 'text-slate-400'}`}></i>
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate before:inline-block before:content-['-'] before:mr-1 " + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                          <i className={`bx bxs-check-square  text-2xl fill-current ${pathname.includes('tasks') ? 'text-indigo-500' : 'text-slate-400'}`}></i>
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                  <i className={`bx bxs-inbox  text-2xl fill-current ${pathname.includes('tasks') ? 'text-indigo-500' : 'text-slate-400'}`}></i>
