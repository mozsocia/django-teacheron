...
const ListProducts = () => {
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: "Short Details", accessor: "short_details" },
      {
        Header: "Price",
        accessor: "price",
      },
      ...
      
      {
        ...
        Cell: ({ row }) => (
          <div>
            <button
              className="btn btn-sm btn-emerald-soft"
            ...
            |
            <button
              className="btn btn-sm btn-indigo-soft "
            ...
            |
            <button
              className="btn btn-sm btn-red-soft"
        ...
        <div className="page-header-right-actions grid grid-cols-max-content gap-2">
          ...
          <Link to={ReactRouterPath + "add"}>
            <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white">
              <svg
                className="w-4 h-4 fill-current opacity-50 mr-1 md:mr-2"
                viewBox="0 0 16 16"
              >
