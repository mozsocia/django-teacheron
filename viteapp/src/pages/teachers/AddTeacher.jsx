        ...
        <div>
          ...
          {formik.errors.date_of_birth && formik.touched.date_of_birth && <div className="text-red-500 text-sm">{formik.errors.date_of_birth}</div>}
              ...
              <div>
                ...
                <input
                  className={`form-input w-full ${formik.touched.qualifications && formik.errors.qualifications && "error-class"}`}
                  id="qualifications"
                  type="text"
                  name="qualifications"
                  ...
                  onBlur={formik.handleBlur}
                />
                {formik.errors.qualifications && formik.touched.qualifications && <div className="text-red-500 text-sm">{formik.errors.qualifications}</div>}
              </div>
              ...
              <div className='mt-6'>
                ...
                <input
                  className={`form-textarea w-full ${formik.touched.experience && formik.errors.experience && "error-class"}`}
                  id="experience"
                  name="experience"
                  ...
                  onBlur={formik.handleBlur}
                />
                {formik.errors.experience && formik.touched.experience && <div className="text-red-500 text-sm">{formik.errors.experience}</div>}
              </div>
              ...
              <div className='mt-6'>
                ...
                <input
                  className={`form-input w-full ${formik.touched.subjects && formik.errors.subjects && "error-class"}`}
                  id="subjects"
                  type="text"
                  name="subjects"
                  ...
                  onBlur={formik.handleBlur}
                />
                {formik.errors.subjects && formik.touched.subjects && <div className="text-red-500 text-sm">{formik.errors.subjects}</div>}
